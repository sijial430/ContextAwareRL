#!/bin/bash
#SBATCH --job-name=qwen3_8B_instruct_baseline
#SBATCH --output=logs/qwen3_8B_instruct_baseline.out
#SBATCH --error=logs/qwen3_8B_instruct_baseline.err
#SBATCH --nodes=1
...
python3 -m verl.trainer.main \
    ...
    data.train_files=/scratch/gpfs/PMITTAL/peiyang/px4668/ImageRL/DataGen/DataSource/rl_gt_qwen3.jsonl \
    ...
    trainer.experiment_name=qwen3_8B_instruct_baseline \
