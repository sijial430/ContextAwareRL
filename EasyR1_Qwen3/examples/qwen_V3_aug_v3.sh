#!/bin/bash
#SBATCH --job-name=qwen3_8B_instruct_aug_logits_v3
#SBATCH --output=logs/qwen3_8B_instruct_aug_logits_v3.out
#SBATCH --error=logs/qwen3_8B_instruct_aug_logits_v3.err
#SBATCH --nodes=1
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen3_8B_instruct_aug_logits_v3 \
