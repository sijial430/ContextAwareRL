...
class ActorConfig:
    ...
    choose_image_coef: float = field(default=0.05, init=False)
    choose_image_clip: float = field(default=5.0, init=False)
    TOKEN_A: int = field(default=32, init=False)
    TOKEN_B: int = field(default=33, init=False)
