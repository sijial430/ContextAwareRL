...
class DataConfig:
    ...
    choose_image_batch_size: int = 32
    """choose-image batch size per training step"""
...
class AlgorithmConfig:
    ...
    choose_image_coef: float = 0.05
    """contrastive loss weight relative to GRPO loss"""
    choose_image_clip: float = 5.0
    """log ratio clip range C (clip to [-C, +C])"""
...
class PPOConfig:
    ...
    def post_init(self):
        ...
        self.worker.actor.choose_image_coef = self.algorithm.choose_image_coef
        self.worker.actor.choose_image_clip = self.algorithm.choose_image_clip
