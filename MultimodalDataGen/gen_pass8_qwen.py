...
if args.start_index is not None or args.end_index is not None:
    ...
    output_file = f"/scratch/gpfs/PMITTAL/peiyang/px4668/ImageRL/DataGen/DataSource/ChooseImgSFT/pass8_results/pass8_results_{start_idx}_{end_idx}.jsonl"
else:
    print(f"Total {len(data_list)} items to process")
    output_file = "/scratch/gpfs/PMITTAL/peiyang/px4668/ImageRL/DataGen/DataSource/ChooseImgSFT/pass8_results/pass8_results.jsonl"
